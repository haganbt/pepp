  ...
  describe("freqDist", function() {
    ...
    it("native nested - 2 level", function() {
      let config = [
        {
          ...
          "child": {
            ...
            "parameters": { "target": "fb.author.age", "threshold": 2 },
            "results": [
              {
                "key": "25-34",
                "interactions": 134300,
        ...
        },
        {
          ...
          "child": {
            ...
            "results": [
              ...
              { "key": "18-24", "interactions": 88800, "unique_authors": 68800 }
            ],
            "redacted": false
          }
        }
      ...
      return format.jsonToCsv(config).then(function(result) {
        ...
        expect(
          result
        ).to.eql("key1,key1_interactions,key1_unique_authors,key2,interactions,unique_authors\n" +
          "São Paulo,429200,291700,25-34,134300,85800\n" +
          "São Paulo,429200,291700,18-24,111300,81500\n" +
          "England,366700,265900,25-34,110900,81800\n" +
          "England,366700,265900,18-24,88800,68800\n");
      });
    });
    ...
    it("native nested - 3 level", function() {
      ...
      return format.jsonToCsv(config).then(function(result) {
        ...
        expect(
          ...
          "England,936900,601300,25-34,271900,167700,male,204200,116600\n" +
          "England,936900,601300,25-34,271900,167700,female,66400,52100\n" +
          "England,936900,601300,18-24,216000,133000,male,162000,90200\n" +
          "England,936900,601300,18-24,216000,133000,female,53600,41700\n" +
          "Texas,921500,509700,25-34,261600,161900,male,171600,85600\n" +
          "Texas,921500,509700,25-34,261600,161900,female,89200,71500\n" +
          "Texas,921500,509700,18-24,219500,111600,male,155900,65000\n" +
          "Texas,921500,509700,18-24,219500,111600,female,63200,48900\n");
      });
    });
    ...
    it("native nested merged - 1 level", function() {
          ...
          "yogi": [
            {
              ...
              "child": {
                "analysis_type": "freqDist",
                "parameters": { "target": "fb.author.gender", "threshold": 2 },
                "results": [
                  {
                    "key": "female",
          ...
          "booboo": [
            {
              ...
              "child": {
                ...
                "results": [
                  ...
                  { "key": "male", "interactions": 700, "unique_authors": 700 }
                ],
                "redacted": false
              }
            },
            {
              ...
              "child": {
                ...
                "results": [
                  ...
                  { "key": "male", "interactions": 400, "unique_authors": 400 }
                ],
                "redacted": false
              }
            },
            {
              ...
              "child": {
                ...
                "results": [
                  ...
                  { "key": "male", "interactions": 200, "unique_authors": 200 }
                ],
                "redacted": false
              }
            },
            ...
            },
            {
              ...
              "child": {
                ...
                "results": [
                  ...
                  { "key": "male", "interactions": 100, "unique_authors": 100 }
                ],
                "redacted": false
              }
            },
      ...
      return format.jsonToCsv(config).then(function(result) {
        ...
        expect(
          result
        ).to.eql("key1,key2,key2_interactions,key2_unique_authors,key3,interactions,unique_authors\n" +
          "yogi,25-34,4053400,3147000,female,2476400,2019500\n" +
          "yogi,25-34,4053400,3147000,male,1551000,1145000\n" +
          "yogi,35-44,3149000,2312800,female,2020200,1481400\n" +
          "yogi,35-44,3149000,2312800,male,1109800,843100\n" +
          "yogi,18-24,2613800,1970300,female,1577300,1186700\n" +
          "yogi,18-24,2613800,1970300,male,1020000,732900\n" +
          "yogi,45-54,2402200,1742200,female,1590200,1160600\n" +
          "yogi,45-54,2402200,1742200,male,797100,574300\n" +
          "yogi,55-64,1575800,1082400,female,1103100,798400\n" +
          "yogi,55-64,1575800,1082400,male,461900,342800\n" +
          "yogi,65+,1009300,743200,female,704900,524800\n" +
          "yogi,65+,1009300,743200,male,295900,215200\n" +
          "booboo,25-34,1700,1600,female,900,900\n" +
          "booboo,25-34,1700,1600,male,700,700\n" +
          "booboo,35-44,1000,900,female,600,500\n" +
          "booboo,35-44,1000,900,male,400,400\n" +
          "booboo,45-54,600,600,female,400,400\n" +
          "booboo,45-54,600,600,male,200,200\n" +
          "booboo,18-24,600,600,female,400,300\n" +
          "booboo,18-24,600,600,male,200,200\n" +
          "booboo,55-64,300,300,female,100,100\n" +
          "booboo,55-64,300,300,male,100,100\n" +
          "booboo,65+,200,100,female,100,100\n");
      });
    });
      ...
      let config = [
        {
          ...
          "child": {
            "analysis_type": "freqDist",
            "parameters": { "target": "fb.parent.author.age", "threshold": 6 },
            "results": [
              {
                "key": "25-34",
                "interactions": 7200,
