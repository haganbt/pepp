...
/**
 * normalizeTask - takes each task object and builds a normalized
...
const normalizeTask = function normalizeTask(tasks, analysis_type, mergedName, globalFilter) {
    ...
    tasks.map(function(task){
        ...
        log.trace("Built normalized properties object for task:", requestObject);
...
;
    ...
    for(let type in configObj){
        ...
        _.each(configObj[type], function (item) {
            ...
            allTasks.push(normalizeTask(taskArr,type, mergedName, globalFilter));
