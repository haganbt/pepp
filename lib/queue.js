...
const responseHandler = function(normalizedTask, response){
    ...
    if(_.has(normalizedTask,'custom_tag')){
      ...
      //  requestParams.custom_tag = task.custom_tag;
        ...
        //normalizedResponse = config.get('customTags.' + normalizedTask.custom_tag);
    } 
        /****!!!
...
const queueRequest = function queueRequest(requestObj, normalizedTask) {
    ...
    if(_.has(normalizedTask,'custom_tag')){
        ...
        console.log("normalized: " + JSON.stringify(normalizedTask.custom_tag,undefined, 4));
    ...
    {    
        return queue.add(function () {
            taskStartCounter ++;
            console.log("sending task: "+taskStartCounter);
