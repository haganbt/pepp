...
function gen(obj, task) {
    return new Promise(function(resolve, reject) {
        ...
        /*
         { bar:
         { total_unique_authors: 1869900,
             '25-34': { male: [Object], female: [Object] },
             '18-24': { male: [Object], female: [Object] },
             '35-44': { male: [Object], female: [Object] },
             '45-54': { male: [Object], female: [Object] },
             '55-64': { male: [Object], female: [Object] },
             '65+': { female: [Object], male: [Object] } },
         foo:
         { total_unique_authors: 6774700,
             '18-24': { male: [Object], female: [Object] },
             '25-34': { male: [Object], female: [Object] },
             '35-44': { male: [Object], female: [Object] },
             '45-54': { male: [Object], female: [Object] },
             '55-64': { male: [Object], female: [Object] },
             '65+': { male: [Object], female: [Object] } } }
         */
        ...
        let out = "id,category,key,total_unique_authors,unique_author,probability\n";

        //level 1 - result set id
        Object.keys(stats).map(function(id){

            //level 2 - age or gender
            Object.keys(stats[id]).map(function(comparatorKey1){
                //console.log(comparatorKey1);

                // does the baseline have the key found in the 1st level comparator?
                if(baseline[comparatorKey1]){

                    // level 3 - age or gender
                    Object.keys(stats[id][comparatorKey1]).map(function(comparatorKey2){

                        // does the baseline have the child key found in the 2nd level comparator?
                        if(baseline[comparatorKey1][comparatorKey2]){

                            baseline[comparatorKey1][comparatorKey2].index = (stats[id][comparatorKey1][comparatorKey2].probability / baseline[comparatorKey1][comparatorKey2].probability);

                            baseline[comparatorKey1][comparatorKey2].expected_baseline = stats[id][comparatorKey1][comparatorKey2].total_unique_authors * baseline[comparatorKey1][comparatorKey2].probability;



                            out += id + "," + comparatorKey1 + "," + comparatorKey2 + ","
                               + stats[id].total_unique_authors   + ","   + stats[id][comparatorKey1][comparatorKey2].unique_authors + ","  + stats[id][comparatorKey1][comparatorKey2].probability + ","
                               + baseline[comparatorKey1][comparatorKey2].index + "," + baseline[comparatorKey1][comparatorKey2].expected_baseline
                                + "\n";

                            //console.log(comparatorKey1, comparatorKey2);
