...
function jsonToCsv(obj) {
    return new Promise(resolve => {
        ...
        let csv = "interactions,unique_authors,activity_rate\n";
        let splitKeys = 0;
        let splitCount = 0;
        let prefix = "";
        let parent = "";
        ...
        let traverse = function traverse(o) {
            for (var i in o) {
                ...
                if(o[i].key && !o[i].child){
                    ...
                    csv += prefix + grandParent + parent + escapeString(o[i].key) + "," + o[i].interactions  + "," + o[i].unique_authors + "," + (o[i].interactions / o[i].unique_authors) + "\n";
                }
