...
function jsonToCsv(obj) {
    return new Promise(resolve => {
        ...
        let traverse = function traverse(o) {
            for (var i in o) {
                ...
                if(o[i].key && !o[i].child){
                    ...
                    totalAuthors = totalAuthors + o[i].unique_authors;
        ...
        for (let idx in probs) {

            probs[idx].local = probs[idx].local || 0;
            probs[idx].local = probs[idx] / probs[idx].localTotalAuthors;
        ...
        console.log(JSON.stringify(probs, undefined, 4));
