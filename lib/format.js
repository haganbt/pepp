...
*/
    ...
    for (let idx in stats.allKeys) {
      ...
      parts.map(i => {
        ...
        //console.log(stats.data[i].interactions);
...
/*
      const aInts = stats.data[a + ','].interactions  + ',' || '';
      const bInts = stats.data[a + ',' + b + ','].interactions  + ',' || '';
      const cInts = stats.data[a + ',' + b + ',' + c].interactions  + ',' || '';
